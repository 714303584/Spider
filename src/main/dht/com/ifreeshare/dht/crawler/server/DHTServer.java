package com.ifreeshare.dht.crawler.server;
...
import com.ifreeshare.dht.crawler.coding.BencodingInputStream;
import com.ifreeshare.dht.crawler.coding.BencodingOutputStream;
...
import com.ifreeshare.dht.crawler.structure.Node;
import com.ifreeshare.dht.crawler.structure.Queue;
import com.ifreeshare.dht.crawler.util.ByteUtil;
import com.ifreeshare.dht.crawler.util.NodeIdUtil;
...
//    private LookupService ls = null;
    ...
    private void responsePing(InetSocketAddress address, byte[] t) {
    	...
    	System.out.println("responsePing " + address.toString());
    ...
    private void responseFindNode(InetSocketAddress address, byte[] t) {
        ...
        System.out.println("responseFindNode " + address.toString());
    ...
    private void responseGetPeers(InetSocketAddress address, byte[] t, byte[] info_hash) {
        ...
        System.out.println("info_hash[GetPeers] : " + address.toString() + " - " + ByteUtil.byteArrayToHex(info_hash));
...
//                System.out.println("node:" + address.getHostString() + ":" + address.getPort());
    ...
    public void ping(InetSocketAddress address) {
        ...
        System.out.println("Ping : " + address.toString());
