<footer class="footer "
		style="color: #777; border-top: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5;  margin-top: 30px; padding: 30px 0;">
		<div class="container-fluid" style="padding:0px">
			<div class="row footer-top" style="padding:15px" >
				<div class="col-sm-6">
					<h4>
						<img src="/static/logo.png">
					</h4>
					<p>法律声明：本站所有资源均来自DHT网络，对于所有文件资源都不会进行本地存储，仅提供BT资源外部信息展示，一切使用后果由浏览者自行承担。 </p>
				</div>
				<div class="col-sm-6">
					<div class="row about">
						<div class="col-3"></div>
