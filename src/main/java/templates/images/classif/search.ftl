	 	...
	 	<div id="mainScreen" class="container"> 
			...
			<div class="container" >
				  <div class="row justify-content-md-center">
				    ...
				    <li class="page-item">
				      <a class="page-link" href="/public/classic/image/${context.classification.id}/?index=${context.pages.previousPageNo}&size=${context.pages.pageSize}" aria-label="Previous">
				        <span aria-hidden="true">&laquo;</span>
				        <span class="sr-only">Previous</span>
				      </a>
				    </li>
				    <li class="page-item">
				      <a class="page-link" href="/public/classic/image/${context.classification.id}/?index=${context.pages.nextPageNo}&size=${context.pages.pageSize}" aria-label="Next">
