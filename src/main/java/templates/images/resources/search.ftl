							...
							<ul id="waterfall" class="masonry" style="position: relative;">
									<#list context.pages.elements as item>
										 <li class="masonry-brick" style="position: absolute; top: 0px; left: 0px;">
								        	<div class="img_block">
								        	 <a href="/public/show/image/resource/?id=${ item.uuid }" >
								            	<img src="http://${context.domain}${item.thumbnail}" alt="">
								             </a>
								            	
								            	 <a href="http://${context.domain}${item.thumbnail}"  rel="lightbox[plants]" class="zoom" style="display: none;">放大</a>
