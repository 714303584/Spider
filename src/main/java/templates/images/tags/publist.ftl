	 	...
	 	<div class="container"> 
			...
			<div class="container" style="text-align:center">
				<div class="row justify-content-md-center">
				    ...
				    <li class="page-item">
				      <a class="page-link" href="/public/tags/page/?index=${context.pages.previousPageNo}&size=${context.pages.pageSize}" aria-label="Previous">
				        <span aria-hidden="true">&laquo;</span>
				        <span class="sr-only">Previous</span>
				      </a>
				    </li>
				    <li class="page-item">
				     <a class="page-link" href="/public/tags/page/?index=${context.pages.nextPageNo}&size=${context.pages.pageSize}" aria-label="Next">
