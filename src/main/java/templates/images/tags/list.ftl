						  ...
						  <#list context.pages.elements as item>
						    <tr>
						     <td> 
						      ...
						      <td><a  href="/admin/tags/edit/${item.id}/" class="btn btn-primary btn-sm">编辑</a>
						      	 <a  href="/admin/image/delete/get/html/?uuid=${item.id}" class="btn btn-primary btn-sm">删除</a> </td>
						    </tr>
						    </#list>
						  </tbody>
					</table>
